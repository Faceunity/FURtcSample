...
订阅回调开始，在 RTCSampleChatViewController.m  的  ` onVideoTexture:(NSString *)uid videoTextureType:(AliRtcVideoTextureType)videoTextureType textureId:(int)textureId width:(int)width height:(int)height extraData:(long)extraData `  方法中会有视频数据的回调，修改其为以下内容：

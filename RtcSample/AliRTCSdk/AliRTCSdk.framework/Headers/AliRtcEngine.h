...
/**
 ...
 - AliRtcNetworkQualityGood: 良
 - AliRtcNetworkQualityNormal: 正常
 - AliRtcNetworkQualityPoor: 差
 - AliRtcNetworkQualityUnkonw: 未知
 */
typedef NS_ENUM(NSUInteger, AliRtcNetworkQuality) {
    AliRtcNetworkQualityGood   = 0,
    AliRtcNetworkQualityNormal = 1,
    AliRtcNetworkQualityPoor   = 2,
    AliRtcNetworkQualityUnkonw = 3,
};
